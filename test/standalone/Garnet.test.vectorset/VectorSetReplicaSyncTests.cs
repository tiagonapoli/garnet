...
namespace Garnet.test
{
    ...
    /// necessary and sufficient. Both empty the store and then drain before advertising the offset.
    ...
    /// </list>
    ///
    /// The injection seams park the respective stage across the boundary to make both races
    /// deterministic, so these self-ignore in Release.
    /// </summary>
    [TestFixture]
