; ===========================================================================
; LightEpoch RyuJIT disassembly -- x86-64
;
; Both variants live in this one file. The `main` section is LightEpoch as on
; origin/main; the `fixed` section is the CAS-carries-the-announce fix. Keeping
; them together is the point -- the litmus tests are a control/fix pair and the
; two instruction streams are meant to be read against each other.
;
; Reduced form: reduced/x86.reduced.asm. Every removal is itemised in
; ../REDUCTION.md; the symbolic location mapping is in ../MODEL.md.
; ===========================================================================


; ###########################################################################
; ## VARIANT: main
; ## LightEpoch as on origin/main -- the announce is a plain store
; ###########################################################################
...
; ###########################################################################
; ## VARIANT: fixed
; ## the claim CAS targets localCurrentEpoch and carries the announce
; ###########################################################################
