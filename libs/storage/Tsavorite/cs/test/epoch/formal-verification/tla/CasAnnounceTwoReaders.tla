------------------------ MODULE CasAnnounceTwoReaders ------------------------
(***************************************************************************)
(* Two readers CONTENDING FOR THE SAME SLOT, plus a reclaimer.             *)
(*                                                                         *)
...
(*                                                           announces      *)
(*             slot.threadId = myThreadId                    ownership tag  *)
(*                                                                         *)
...
(*                    threadId. This is not cosmetic: ThisInstanceProtected *)
...
\* ThisInstanceProtected() returns `slot.threadId == Metadata.threadId`, so a
\* wiped threadId makes a genuinely protected thread report itself unprotected.
PublishThreadId(r) ==
