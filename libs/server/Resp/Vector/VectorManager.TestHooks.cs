...
namespace Garnet.server
{
    ...
    public sealed partial class VectorManager
    {
        ...
        /// </summary>
        private static void TestHookCollectReservedContexts(in ContextMetadata metadata, ulong offset, List<ulong> into)
        {
        ...
        internal int TestHookGetReservedContextCount()
        {
            lock (this)
            {
                ...
                {
                    count += BitOperations.PopCount(contextMetadatas[i].ReservedMask);
                }
